...
export default function BudgetOverviewCard({ totalBudget, percentUsed, subtitle = 'Total Budget Set' }) {
  ...
  return (
    <div className="relative flex h-full flex-col overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-600 via-indigo-700 to-violet-800 p-5 text-white shadow-lg">
      ...
      <div className="relative flex flex-1 items-center gap-4">
        <div>
          ...
          <p className="mt-0.5 text-[11px] text-indigo-200">{subtitle}</p>
        </div>
      ...
      <div className="bm-gh-edge relative -mx-5 -mb-5 mt-3 h-1 opacity-90" aria-hidden="true" />
    </div>
  )
}
