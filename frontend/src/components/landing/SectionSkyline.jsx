...
export default function SectionSkyline({ side = 'right' }) {
  if (side === 'left') {
    return (
      <div className="pointer-events-none absolute inset-y-0 left-0 w-full max-w-md overflow-hidden" aria-hidden="true">
        <img src={accraSkyline} alt="" className="absolute inset-y-0 left-0 h-full w-full object-cover object-center opacity-[0.12] dark:opacity-[0.08]" />
  ...
  return (
    <div className="pointer-events-none absolute inset-y-0 right-0 w-full max-w-md overflow-hidden" aria-hidden="true">
      <img src={accraSkyline} alt="" className="absolute inset-y-0 right-0 h-full w-full object-cover object-center opacity-[0.12] dark:opacity-[0.08]" />
